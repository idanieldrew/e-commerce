...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('admin-assets/assets/admin-assets/dist/img/ico/favicon.png') }}" type="image/x-icon">
    ...
    <!-- Bootstrap rtl -->
    <!--<link href="ootstrap-rtl/bootstrap-rtl.min.css" rel="stylesheet" type="text/css"/>-->
    <!-- Lobipanel css -->
    ...
    <!-- Theme style rtl -->
    <!--<link href="ist/css/stylecrm-rtl.css" rel="stylesheet" type="text/css"/>-->
